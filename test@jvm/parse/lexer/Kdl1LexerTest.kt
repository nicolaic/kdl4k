...
internal class Kdl1LexerTest {
    ...
    companion object {
        ...
        fun validTestCases(): List<Arguments> = listOf(
            ...
            Arguments.of("\ufeff", Whitespace("\ufeff", Span.of(1, 1))),
            Arguments.of(" ", Whitespace(" ", Span.of(1, 1))),
            Arguments.of("\t", Whitespace("\t", Span.of(1, 1))),
            Arguments.of("\t ", Whitespace("\t ", Span.of(1, 1, 1, 2))),
            Arguments.of(
                "/* hi!\n */a",
                Whitespace("/* hi!\n */", Span.of(1, 1, 2, 3)),
                BareIdentifier("a", Span.of(2, 4))
            ),
            ...
            Arguments.of(
                "/* hi /* there */ everyone */",
                Whitespace("/* hi /* there */ everyone */", Span.of(1, 1, 1, 29))
            ),
            Arguments.of("/* hello\n girls/boys */", Whitespace("/* hello\n girls/boys */", Span.of(1, 1, 2, 14))),
            Arguments.of("\\", LineContinuation("\\", Span.of(1, 1))),
            Arguments.of(" \\", Whitespace(" ", Span.of(1, 1)), LineContinuation("\\", Span.of(1, 2))),
            Arguments.of(
                "\\\n   ",
                LineContinuation("\\\n", Span.of(1, 1, 1, 2)),
                Whitespace("   ", Span.of(2, 1, 2, 3))
            ),
            Arguments.of(
                "\\\r\n   ",
                LineContinuation("\\\r\n", Span.of(1, 1, 1, 3)),
            ...
            Arguments.of(
                "\\   // single-line comment",
                LineContinuation("\\   // single-line comment", Span.of(1, 1, 1, 26))
            ),
            Arguments.of(
                "\\ /* multi-line\n comment */  // single-line comment",
                LineContinuation("\\ /* multi-line\n comment */  // single-line comment", Span.of(1, 1, 2, 35))
            ),
            Arguments.of(
                "\\   \na",
                LineContinuation("\\   \n", Span.of(1, 1, 1, 5)),
                BareIdentifier("a", Span.of(2, 1))
            ),
            Arguments.of(
                "a  \\   \nb",
                BareIdentifier("a", Span.of(1, 1)),
                Whitespace("  ", Span.of(1, 2, 1, 3)),
                LineContinuation("\\   \n", Span.of(1, 4, 1, 8)),
                BareIdentifier("b", Span.of(2, 1))
            ),
            Arguments.of(
                "//\na",
                SingleLineComment("//\n", Span.of(1, 1, 1, 3)),
            ...
            Arguments.of("/-   ", Slashdash("/-   ", Span.of(1, 1, 1, 5))),
            Arguments.of(
                "/-   /* multiline\ncomment */\n\n  ",
                Slashdash("/-   /* multiline\ncomment */", Span.of(1, 1, 2, 10)),
                Newline("\n", Span.of(2, 11)),
                Newline("\n", Span.of(3, 1)),
                Whitespace("  ", Span.of(4, 1, 4, 2))
            ),
            Arguments.of(
                "/- \\  \nabc",
                Slashdash("/- \\  \n", Span.of(1, 1, 1, 7)),
                BareIdentifier("abc", Span.of(2, 1, 2, 3))
            ),
            ...
            Arguments.of("a", BareIdentifier("a", Span.of(1, 1))),
            Arguments.of("abc", BareIdentifier("abc", Span.of(1, 1, 1, 3))),
            Arguments.of("-", BareIdentifier("-", Span.of(1, 1))),
            Arguments.of("-abc", BareIdentifier("-abc", Span.of(1, 1, 1, 4))),
            Arguments.of(". ", BareIdentifier(".", Span.of(1, 1)), Whitespace(" ", Span.of(1, 2))),
            Arguments.of(".abc ", BareIdentifier(".abc", Span.of(1, 1, 1, 4)), Whitespace(" ", Span.of(1, 5))),
            Arguments.of("+.abc", BareIdentifier("+.abc", Span.of(1, 1, 1, 5))),
            ...
            Arguments.of("\"\\u{100000}\"", StringToken("\uDBC0\uDC00", Span.of(1, 1, 1, 12))),
            Arguments.of("\"a\n\"", StringToken("a\n", Span.of(1, 1, 2, 1))),
            Arguments.of("r\"abc\"", StringToken("abc", Span.of(1, 1, 1, 6))),
            Arguments.of("r#\"\"abc\"\"#", StringToken("\"abc\"", Span.of(1, 1, 1, 10))),
            Arguments.of(
                "r##\"Hello\\n\\r\\asd\"#world\"##",
                StringToken("Hello\\n\\r\\asd\"#world", Span.of(1, 1, 1, 27))
            ),
            Arguments.of("r###\"\"#\"##\"###", StringToken("\"#\"##", Span.of(1, 1, 1, 14))),
            Arguments.of("r\"\nhello\nworld\n\"", StringToken("\nhello\nworld\n", Span.of(1, 1, 4, 1))),
            Arguments.of("true", BooleanToken(true, "true", Span.of(1, 1, 1, 4))),
            Arguments.of("false", BooleanToken(false, "false", Span.of(1, 1, 1, 5))),
            Arguments.of("null", Null(Span.of(1, 1, 1, 4))),
            Arguments.of("123", NumberToken.Integer(BigInteger(123), Span.of(1, 1, 1, 3))),
            Arguments.of("+123", NumberToken.Integer(BigInteger(123), Span.of(1, 1, 1, 4))),
            Arguments.of("-123", NumberToken.Integer(BigInteger(-123), Span.of(1, 1, 1, 4))),
            Arguments.of("-1_2_3", NumberToken.Integer(BigInteger(-123), Span.of(1, 1, 1, 6))),
            Arguments.of("-_123", BareIdentifier("-_123", Span.of(1, 1, 1, 5))),
            Arguments.of("0x12", NumberToken.Integer(BigInteger(18L), Span.of(1, 1, 1, 4))),
            Arguments.of("0x1_2", NumberToken.Integer(BigInteger(18L), Span.of(1, 1, 1, 5))),
            Arguments.of("-0x12", NumberToken.Integer(BigInteger(-18L), Span.of(1, 1, 1, 5))),
            Arguments.of("0o12", NumberToken.Integer(BigInteger(10L), Span.of(1, 1, 1, 4))),
            Arguments.of("0o1_2", NumberToken.Integer(BigInteger(10L), Span.of(1, 1, 1, 5))),
            Arguments.of("-0o12", NumberToken.Integer(BigInteger(-10L), Span.of(1, 1, 1, 5))),
            Arguments.of("0b101", NumberToken.Integer(BigInteger(5L), Span.of(1, 1, 1, 5))),
            Arguments.of("0b1_01", NumberToken.Integer(BigInteger(5L), Span.of(1, 1, 1, 6))),
            Arguments.of("-0b101", NumberToken.Integer(BigInteger(-5L), Span.of(1, 1, 1, 6))),
            Arguments.of("2.5", NumberToken.Decimal(BigDecimal("2.5"), Span.of(1, 1, 1, 3))),
            Arguments.of("123.456", NumberToken.Decimal(BigDecimal("123.456"), Span.of(1, 1, 1, 7))),
            Arguments.of("123_456.789", NumberToken.Decimal(BigDecimal("123456.789"), Span.of(1, 1, 1, 11))),
            Arguments.of("-123.456", NumberToken.Decimal(BigDecimal("-123.456"), Span.of(1, 1, 1, 8))),
            Arguments.of("123e3", NumberToken.Decimal(BigDecimal("1.23E5"), Span.of(1, 1, 1, 5))),
            Arguments.of("1_2_3e3_", NumberToken.Decimal(BigDecimal("1.23E5"), Span.of(1, 1, 1, 8))),
            Arguments.of("-123.456e-3", NumberToken.Decimal(BigDecimal("-0.123456"), Span.of(1, 1, 1, 11))),
            Arguments.of(
                "123 123",
                NumberToken.Integer(BigInteger(123), Span.of(1, 1, 1, 3)),
                Whitespace(" ", Span.of(1, 4)),
                NumberToken.Integer(BigInteger(123), Span.of(1, 5, 1, 7))
            ),
            Arguments.of(
                "(type) node",
                OpeningParentheses(Span.of(1, 1)),
                BareIdentifier("type", Span.of(1, 2, 1, 5)),
                ClosingParentheses(Span.of(1, 6)),
                Whitespace(" ", Span.of(1, 7)),
                BareIdentifier("node", Span.of(1, 8, 1, 11))
            ),
            Arguments.of(
                "node 0xabcdef1234567890",
                BareIdentifier("node", Span.of(1, 1, 1, 4)),
                Whitespace(" ", Span.of(1, 5)),
                NumberToken.Integer(BigInteger("abcdef1234567890", 16), Span.of(1, 6, 1, 23))
            ),
            Arguments.of("/**m/g/*/N*/*/", Whitespace("/**m/g/*/N*/*/", Span.of(1, 1, 1, 14)))
        )
