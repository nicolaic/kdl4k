...
class Kdl2ParserRoundTripTest : RoundTripTest(KdlVersion.V2) {
    ...
    companion object {
        ...
        private val INPUT_FOLDER: Path = Path("testResources/test-cases/v2/input")
        private val EXPECTED_FOLDER: Path = Path("testResources/test-cases/v2/expected")
    }
}
